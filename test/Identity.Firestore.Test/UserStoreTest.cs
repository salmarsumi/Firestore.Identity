...
namespace Identity.Firestore.Test
{
    public class UserStoreTest
    {
        ...
        {
            var store = new FirestoreUserStore<IdentityUser>(new Mock<IFirestoreDbContext>().Object);
            store.Dispose();
        ...
        {
            Assert.Throws<ArgumentNullException>("db", () => new FirestoreUserStore<IdentityUser>(null));
            var store = new FirestoreUserStore<IdentityUser>(new Mock<IFirestoreDbContext>().Object);
